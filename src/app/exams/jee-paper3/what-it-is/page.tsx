    ...
    <main className="flex-grow flex flex-col bg-slate-50 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto w-full px-6 lg:px-12 pb-24">
        <Section number="01" title="Exam Structure & Question Distribution">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
            <div className="border border-slate-200 bg-white rounded-2xl p-6 shadow-sm">
              <span className="text-xs font-black uppercase tracking-widest text-slate-400">Part I</span>
              ...
              <div className="text-lg font-black text-slate-700 mt-4">100 Marks</div>
            </div>

            <div className="border border-slate-200 bg-white rounded-2xl p-6 shadow-sm">
              <span className="text-xs font-black uppercase tracking-widest text-slate-400">Part II</span>
              ...
              <div className="text-lg font-black text-slate-700 mt-4">200 Marks</div>
            </div>

            <div className="border border-slate-200 bg-white rounded-2xl p-6 shadow-sm">
              <span className="text-xs font-black uppercase tracking-widest text-slate-400">Part III</span>
        ...
        <Section number="02" title="Part I: Mathematics Syllabus">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 bg-slate-50 border border-slate-200 rounded-2xl p-6 md:p-8">
            <div>
              <h4 className="font-black text-slate-800 mb-2">High Weightage Topics</h4>
              <ul className="list-disc pl-5 space-y-2 text-slate-650 font-semibold text-sm">
            ...
            <div>
              <h4 className="font-black text-slate-800 mb-2">Algebra & Trigonometry</h4>
              <ul className="list-disc pl-5 space-y-2 text-slate-650 font-semibold text-sm">
        ...
        <Section number="03" title="Part II: General Aptitude Syllabus">
          ...
          <div className="space-y-6">
            <div className="border border-slate-100 bg-white p-6 rounded-xl shadow-sm">
              <h4 className="font-black text-slate-800 text-lg mb-2">1. Visual & Spatial Aptitude</h4>
              <p className="text-slate-650 leading-relaxed font-semibold text-sm">
            ...
            <div className="border border-slate-100 bg-white p-6 rounded-xl shadow-sm">
              <h4 className="font-black text-slate-800 text-lg mb-2">2. Analytical Reasoning & Mental Ability</h4>
              <p className="text-slate-650 leading-relaxed font-semibold text-sm">
                Pattern recognition, series completions, logical deductions, blood relation puzzles, coding-decoding, and Venn diagrams.
              </p>
            </div>
            <div className="border border-slate-100 bg-white p-6 rounded-xl shadow-sm">
              <h4 className="font-black text-slate-800 text-lg mb-2">3. Architecture, Cities & History GK</h4>
              <p className="text-slate-650 leading-relaxed font-semibold text-sm">
        ...
        <Section number="04" title="Part III: Planning-Based Questions (Specialized)">
          ...
          <div className="border border-slate-200 bg-slate-50 rounded-2xl p-6 md:p-8 space-y-6">
            <div>
