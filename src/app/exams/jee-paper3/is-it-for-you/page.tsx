...
const InfoBox = ({
  ...
  <div
    className={`p-6 md:p-8 my-8 rounded-2xl border-l-4 ${type === "info" ? "bg-teal-50 border-teal-500" : "bg-orange-50 border-accent"}`}
  >
    {children}
  </div>
);
    ...
    <main className="flex-grow flex flex-col bg-slate-50 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto w-full px-6 lg:px-12 pb-24">
        <Section number="01" title="Honest Comparison: Planning vs. Architecture vs. Civil Engineering">
          ...
          <div className="overflow-x-auto border border-slate-200 rounded-2xl my-8 bg-white">
            <table className="w-full text-left border-collapse min-w-[700px]">
              <thead className="bg-slate-50">
                <tr>
                  <th className="p-4 font-black text-xs uppercase tracking-widest text-slate-500 border-b border-slate-200">Feature</th>
                  <th className="p-4 font-black text-xs uppercase tracking-widest text-teal-700 border-b border-slate-200">Bachelor of Planning (B.Plan)</th>
                  <th className="p-4 font-black text-xs uppercase tracking-widest text-slate-500 border-b border-slate-200">Bachelor of Architecture (B.Arch)</th>
                  <th className="p-4 font-black text-xs uppercase tracking-widest text-slate-500 border-b border-slate-200">Civil Engineering (B.Tech)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="p-4 font-black text-slate-700 border-b border-slate-100">Primary Scale</td>
                  <td className="p-4 text-teal-750 font-bold border-b border-slate-100">Macro (City, Region, Transit corridors)</td>
                  <td className="p-4 text-slate-650 border-b border-slate-100 font-semibold">Micro (Individual buildings, sites)</td>
                  <td className="p-4 text-slate-650 border-b border-slate-100 font-semibold">Structural (Materials, soil mechanics, load)</td>
                </tr>
                <tr>
                  <td className="p-4 font-black text-slate-700 border-b border-slate-100">Core Focus</td>
                  <td className="p-4 text-teal-750 font-bold border-b border-slate-100">Policy, zoning laws, traffic patterns, sustainability</td>
                  <td className="p-4 text-slate-650 border-b border-slate-100 font-semibold">Aesthetics, spatial design, material detailing</td>
                  <td className="p-4 text-slate-650 border-b border-slate-100 font-semibold">Construction feasibility, structural safety</td>
                </tr>
                <tr>
                  <td className="p-4 font-black text-slate-700 border-b border-slate-100">Key Software Tools</td>
                  <td className="p-4 text-teal-750 font-bold border-b border-slate-100">ArcGIS, QGIS, AutoCAD Map 3D, SPSS (statistics)</td>
                  <td className="p-4 text-slate-650 border-b border-slate-100 font-semibold">Revit, Rhino, SketchUp, Photoshop</td>
                  <td className="p-4 text-slate-650 border-b border-slate-100 font-semibold">STAAD.Pro, ETABS, MS Project, Primavera</td>
                </tr>
                <tr>
                  <td className="p-4 font-black text-slate-700">Drawing Requirement</td>
                  <td className="p-4 text-teal-750 font-bold">None. No drawing test is conducted for B.Plan admissions.</td>
                  <td className="p-4 text-slate-650 font-semibold">High. Freehand sketching and scale drawing are core.</td>
                  <td className="p-4 text-slate-650 font-semibold">None. Focused strictly on physics and mathematics.</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <Section number="03" title="Professional Realities & Growth Path">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
            <div className="border border-slate-200 rounded-2xl p-6 bg-white">
              <h4 className="font-black text-slate-800 text-lg mb-3">1. Typical Work Environment</h4>
            ...
            <div className="border border-slate-200 rounded-2xl p-6 bg-white">
              <h4 className="font-black text-slate-800 text-lg mb-3">2. Career Evolution</h4>
              <p className="text-slate-650 text-sm leading-relaxed font-semibold">
