      ...
      <div className="px-6 lg:px-12 pb-20 md:pb-32 max-w-4xl mx-auto w-full space-y-20 mt-12">
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            {/* Card 1 */}
            <Link href="/exams/jee-paper3/what-it-is" className="group flex flex-col md:flex-row gap-6 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-[2rem] p-6 md:p-8 hover:border-teal-300 hover:bg-white/90 transition-all duration-300 shadow-sm hover:shadow-xl hover:shadow-teal-500/5 hover:-translate-y-1">
            ...
            {/* Card 3 */}
            <Link href="/exams/jee-paper3/resources" className="group flex flex-col md:flex-row gap-6 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-[2rem] p-6 md:p-8 hover:border-teal-300 hover:bg-white/90 transition-all duration-300 shadow-sm hover:shadow-xl hover:shadow-teal-500/5 hover:-translate-y-1">
