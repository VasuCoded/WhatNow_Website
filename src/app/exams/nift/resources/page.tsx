      ...
      <div className="max-w-5xl mx-auto w-full px-6 lg:px-12 pb-24">
        <Section number="01" title="Syllabus Breakdown: CAT & GAT">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
            <div className="border border-slate-200 rounded-2xl p-6 bg-white shadow-xs">
              ...
              <h4 className="font-black text-lg text-neutral-dark mb-2">Drawing & Visualisation</h4>
            ...
            <div className="border border-slate-200 rounded-2xl p-6 bg-white shadow-xs">
              ...
              <h4 className="font-black text-lg text-neutral-dark mb-2">General Aptitude</h4>
              <p className="text-xs text-slate-550 font-semibold leading-relaxed">
        ...
        <Section number="02" title="Recommended Guides & Material Kits">
          <div className="space-y-6">
            <div className="border-l-4 border-pink-500/80 pl-6">
              <h4 className="font-black text-lg text-neutral-dark mb-2">Primary Reference Books</h4>
            ...
            <div className="border-l-4 border-emerald-500/80 pl-6">
              <h4 className="font-black text-lg text-neutral-dark mb-2">Situation Test Material Kit (20% Weightage)</h4>
              ...
              <ul className="list-disc list-inside text-xs text-slate-600 font-semibold space-y-1">
        ...
        <Section number="03" title="Self-Prep Roadmap">
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 md:p-8">
            <h3 className="text-lg font-black text-neutral-dark mb-4">Timely Preparation Flow</h3>
            <p className="text-slate-650 leading-relaxed font-semibold mb-4 text-sm">
