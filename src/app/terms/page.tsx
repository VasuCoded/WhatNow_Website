      ...
      <div className="max-w-4xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <article className="flex-1 min-w-0">
            {/* Intro */}
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed font-medium mb-10 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/40">
              {en.intro}
            </p>
            ...
            <section id="no-guarantees" className="mb-10">
              ...
              {en.sections.noGuarantees.body.split("\n\n").map((para, i) => (
                <p key={i} className={`text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4 font-medium ${i === 1 ? "font-black text-slate-900 dark:text-slate-100" : ""}`}>
                  {para}
                </p>
              ))}
            </section>
